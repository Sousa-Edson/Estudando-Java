...
public class TipoForm extends javax.swing.JFrame {
    ...
    Conversor manipulateString = new Conversor();
    int idUnidade = 0;

    public TipoForm() {
        initComponents();
        controller = new TipoController(this);
    ...
    private void initComponents() {
        ...
        lblVersao.setText("Listar e cadastrar tipos");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TipoForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
